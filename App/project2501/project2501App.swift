...
import AppKit
import Project2501Core
import SwiftUI

@main
struct project2501App: SwiftUI.App {
...
private extension project2501App {
    ...
    var helpMenuCommands: some Commands {
        CommandGroup(replacing: .help) {
            ...
            Button("Keyboard Shortcuts") {
                openURL("https://docs.project2501.ai/keyboard-shortcuts")
            }
