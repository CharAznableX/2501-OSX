...
create-dmg \
  ...
  --window-size 600 400 \
  --icon-size 100 \
  --icon "project2501.app" 150 185 \
  --hide-extension "project2501.app" \
  --app-drop-link 450 185 \
  "build_output/Project2501-${VERSION}.dmg" \
  "build_output/project2501.app" || true

if [ ! -f "build_output/Project2501-${VERSION}.dmg" ]; then
...
cp "build_output/Project2501-${VERSION}.dmg" "build_output/Project2501.dmg"
