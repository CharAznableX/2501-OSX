...
struct VecturaRecoveryTests {
    ...
    @Test func initToleratesCorruptFilesGracefully() async throws {
        ...
        let documentsDir = dir.appendingPathComponent("project2501-corrupt/documents", isDirectory: true)
    ...
    @Test func recoveryAfterDeletingCorruptStorage() async throws {
        ...
        let documentsDir = dir.appendingPathComponent("project2501-recovery/documents", isDirectory: true)
        try FileManager.default.createDirectory(at: documentsDir, withIntermediateDirectories: true)
