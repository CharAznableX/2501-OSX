...
/// A pair of (privateKey, project2501Address) for use in tests.
...
enum TestKeys {
    ...
    static var aliceAddress: Project2501ID { try! deriveProject2501Id(from: alicePrivateKey) }
    ...
    static var bobAddress: Project2501ID { try! deriveProject2501Id(from: bobPrivateKey) }
    ...
    static var carolAddress: Project2501ID { try! deriveProject2501Id(from: carolPrivateKey) }
}
...
enum TokenBuilder {
    static func build(
        ...
        lbl: String? = "test",
        signingPrefix: String = "Project2501 Signed Access"
    ) throws -> String {
...
extension APIKeyValidator {
    ...
    static func forAlice(
        agentAddress: Project2501ID? = nil,
        extraWhitelist: Set<Project2501ID> = [],
        ...
        var wl: Set<Project2501ID> = [master.lowercased(), agent.lowercased()]
