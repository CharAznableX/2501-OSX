        ...
        VStack(spacing: 0) {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    case .ready(let project2501Id, let deviceId):
                        MasterAddressSection(project2501Id: project2501Id)
                        AgentAddressesSection(masterAddress: project2501Id)
...
private struct RecoveryPromptCard: View {
    ...
    private var recoveryCard: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 6) {
                recoveryField(label: "Master Address", value: info.project2501Id)
    ...
    private func dismiss() {
        onDismiss(info.project2501Id, info.deviceId)
    }
}
...
private struct MasterAddressSection: View {
    ...
    private func copyId() {
        ...
        NSPasteboard.general.setString(project2501Id, forType: .string)
