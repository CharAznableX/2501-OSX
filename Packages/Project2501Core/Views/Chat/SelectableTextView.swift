...
extension NSAttributedString.Key {
    ...
    static let blockquoteMarker = NSAttributedString.Key("project2501.blockquote")
    /// Marks a range as a heading that should have an underline (H1/H2)
    static let headingUnderline = NSAttributedString.Key("project2501.headingUnderline")
}
