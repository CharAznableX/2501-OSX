...
private struct RelaysSectionView: View {
    ...
    var body: some View {
        ...
        .alert("Expose Agent to Internet?", isPresented: $showRelayConfirmation) {
            ...
            Text(
                "This will create a public URL for this agent via agent.project2501.ai. Anyone with the URL can send requests to your local server. Your access keys still protect the API endpoints."
            )
        }
        .task {
...
private struct APIReferenceTabContent: View {
    ...
    private var documentationSection: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Button(action: {
                if let url = URL(string: "https://docs.project2501.ai/") {
