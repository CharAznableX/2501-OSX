...
public enum Project2501Identity {
    ...
    /// The complete identity introduction
    ...
    /// Personality traits for the formless entity
    public static let personalityTraits = """
    // ============================================
    // Personality traits
    // ============================================
    ...
    /// Returns the complete identity with all components
    public static func fullIdentity() -> String {
        return intro
    }
}
