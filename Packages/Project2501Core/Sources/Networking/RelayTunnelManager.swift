...
//  project2501
//
//  Manages a single WebSocket tunnel to the project2501-relay service.
...
public final class RelayTunnelManager: ObservableObject {
    ...
    private static let relayURL = URL(string: "wss://agent.project2501.ai/tunnel/connect")!
    ...
    private static func signAgentAuth(
        ...
        let message = "project2501-tunnel:\(address):\(nonce):\(timestamp)"
