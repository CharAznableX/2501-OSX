...
//
    ...
    enum MockChatData {
        ...
        private static let mockArtifactRootURL: URL = {
            ...
            let dir = base.appendingPathComponent("project2501-mock-\(UUID().uuidString)", isDirectory: true)
            ...
            case 4:
                ...
                turn.toolCalls = [
                    ToolCall(
                        ...
                        function: ToolCallFunction(
                            name: "run_command",
                            arguments: "{\"command\": \"xcodebuild -scheme project2501 test\"}"
                        )
                    )
                ]
        ...
        private static let markdownRichStatic = """
            ...
            ```bash
            xcodebuild -scheme project2501 -destination 'platform=macOS' build 2>&1 | tail -n 20
            ```
            """
