...
//  without any changes required in project2501.
//
...
private let accumSignposter = OSSignposter(subsystem: "ai.project2501", category: "Generation")
private let accumLog = Logger(subsystem: "ai.project2501", category: "Generation")
