...
public enum ToolIndexLogger {
    static let search = Logger(subsystem: "ai.project2501", category: "toolindex.search")
    static let service = Logger(subsystem: "ai.project2501", category: "toolindex.service")
}
