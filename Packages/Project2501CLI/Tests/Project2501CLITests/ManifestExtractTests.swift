...
final class ManifestExtractTests: XCTestCase {
    ...
    override func setUp() {
        ...
        tempDir = FileManager.default.temporaryDirectory
            .appendingPathComponent("project2501-manifest-test-\(UUID().uuidString)", isDirectory: true)
    ...
    func testErrorDescriptions() {
        let cases: [(ManifestExtract.ExtractionError, String)] = [
            ...
            (.missingEntryPoint, "Missing plugin entry point (project2501_plugin_entry or project2501_plugin_entry_v2)"),
