...
final class ToolsCreateTests: XCTestCase {
    ...
    override func setUp() {
        ...
        tempDir = FileManager.default.temporaryDirectory
            .appendingPathComponent("project2501-test-\(UUID().uuidString)", isDirectory: true)
    ...
    func testSwiftPluginContainsV2EntryPoint() throws {
        ...
        XCTAssertTrue(content.contains("project2501_plugin_entry_v2"))
        XCTAssertTrue(content.contains("project2501_plugin_entry"))
