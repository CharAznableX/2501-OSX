...
help:
	...
	@echo "  app            Build app ($(SCHEME_APP)) and embed CLI + uv"
...
app: cli
	...
	@echo "Embedding uv + vmlx-engine resources…"
	mkdir -p "$(DERIVED)/Build/Products/$(CONFIG)/osaurus.app/Contents/Resources"
	cp Resources/uv "$(DERIVED)/Build/Products/$(CONFIG)/osaurus.app/Contents/Resources/uv"
	chmod +x "$(DERIVED)/Build/Products/$(CONFIG)/osaurus.app/Contents/Resources/uv"
	cp -a Resources/vmlx_engine "$(DERIVED)/Build/Products/$(CONFIG)/osaurus.app/Contents/Resources/vmlx_engine"
